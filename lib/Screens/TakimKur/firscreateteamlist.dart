...
class FirstMyTeamPage extends StatefulWidget {
  FirstMyTeamPage({Key key,  this.title}) : super(key: key);
  final String title;

  @override
  _FirstMyTeamPageState createState() => _FirstMyTeamPageState();
}

class _FirstMyTeamPageState extends State<FirstMyTeamPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
          ...
          appBar: AppBar(centerTitle: true,title: Text('Bütçe '+global.Butce.toString()+'M ₺'),
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          GestureDetector(
                            ...
                            child: Container(alignment: Alignment.center,
                              width: 100,height: 35,color: Colors.red,
                              child: Text(
                                "Vazgeç",
                                style: TextStyle(
                                    color: Colors.white,
                          ...
                          GestureDetector(
                              ...
                              if(global.hatamsj==11){
                                ...
                                return   showDialog(
                                    ...
                                    builder: (BuildContext context){
                                      return AlertDialog(backgroundColor: Colors.red.shade700,
                                          title: Text(
                                            "Bu oyuncu zaten kadronda var",style: TextStyle(
                                              color: Colors.white
                                          ),
                                            textAlign: TextAlign.center,
                                          ),
                            ...
                            child: Container(alignment: Alignment.center,
                              width: 100,height: 35,color: Colors.green,
                              child: Text(
                                "Tamam",
                                style: TextStyle(
                                    color: Colors.white,
              ...
              child: Row(
                children: <Widget>[
                  Container(
                    ...
                    child: Text(Oyuncugetir.oyuncular[index].Form==null?'0':Oyuncugetir.oyuncular[index].Form),
                  ...
                  Container(
                    child: Text(Oyuncugetir.oyuncular[index].WeekPoints.toString()==null?'0':Oyuncugetir.oyuncular[index].WeekPoints.toString()),
                  ...
                  Container(
                    child: Text(Oyuncugetir.oyuncular[index].SeasonPoints.toString()==null?'0':Oyuncugetir.oyuncular[index].SeasonPoints.toString()),
                    // child: Image.network(player.oyuncular[index].Kits),
                    // child: Text(player.oyuncular[index].PlayerShortName),
                    width: 25,
                    height: 52,
