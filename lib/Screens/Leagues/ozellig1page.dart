...
class Ozel1LeaguePage extends StatefulWidget {
  @override
  _Ozel1LeaguePageState createState() => _Ozel1LeaguePageState();
}

class _Ozel1LeaguePageState extends State<Ozel1LeaguePage> {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          centerTitle: true,title: Text(global.OzelLig1Adi),
