...
import 'package:fantasysuperlig/Screens/Puanim/targetyillikpage.dart';
import 'package:fantasysuperlig/Services/player_api.dart';
import 'package:flutter/material.dart';
import '../../Variables/global.dart' as global;


class YillikLeaguePage extends StatefulWidget {
  @override
  _YillikLeaguePageState createState() => _YillikLeaguePageState();
}

class _YillikLeaguePageState extends State<YillikLeaguePage> {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          centerTitle: true,title: Text('Yıllık Ligler'),
                      ...
                      return Column(
                        children: [
                          ...
                          InkWell(
                            ...
                            //  Navigator.push(context, MaterialPageRoute(builder: (context)=>TargetYillikPointPage(),settings: RouteSettings(arguments: data)));
                            },
                            child: Stack(
                              children: [
