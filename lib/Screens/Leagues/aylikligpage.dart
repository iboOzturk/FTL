...
class AylikLeaguePage extends StatefulWidget {
  @override
  _AylikLeaguePageState createState() => _AylikLeaguePageState();
}

class _AylikLeaguePageState extends State<AylikLeaguePage> {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          centerTitle: true,title: Text('Aylık Ligler'),
