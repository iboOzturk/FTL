...
class KuponOlusturPage extends StatefulWidget {
  @override
  _KuponOlusturPageState createState() => _KuponOlusturPageState();
}

class _KuponOlusturPageState extends State<KuponOlusturPage> {
  bool ontl=false;
  bool yirmitl=false;
  bool kirktl=false;
  int type;
        ...
        body: Container(
          ...
          decoration: BoxDecoration(
            ...
            gradient: LinearGradient(
              colors: [
                Colors.blue.shade900,Colors.orange,Colors.orange,Colors.pink.shade200
              ],
