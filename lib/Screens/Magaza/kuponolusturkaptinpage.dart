...
class KuponOlusturKaptinPage extends StatefulWidget {
  @override
  _KuponOlusturKaptinPageState createState() => _KuponOlusturKaptinPageState();
}

class _KuponOlusturKaptinPageState extends State<KuponOlusturKaptinPage> {
  bool ontl=false;
  bool yirmitl=false;
  bool kirktl=false;
  int type;
          ...
          decoration: BoxDecoration(
            //color: Colors.pink,
              gradient: LinearGradient(
                  colors: [
                    Colors.blue.shade900,Colors.black,Colors.grey.shade900,Colors.pink.shade200
                  ],
                                ...
                                Container(alignment: Alignment.centerLeft,
                                  child: Row(
                                    children: [
                                      ...
                                      Text('10 TL',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold)),
                                    ],
                                  ),
                                ),
                                Container(alignment: Alignment.centerRight,
                                  padding: EdgeInsets.only(right: 16),
                                  child: Text('50 TL ve üstü Alışverişte',textAlign: TextAlign.right,
                                ...
                                Container(
                                  child: Row(
                                    children: [
                                      ...
                                      Text('40 TL',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold)),
                                    ],
                                  ),
                                ),
                                Container(alignment: Alignment.centerRight,
                                  padding: EdgeInsets.only(right: 16),
                                  child: Text('200 TL ve üstü Alışverişte',textAlign: TextAlign.right,
                                      style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold)),
                                ),
                              ],
                            ),
