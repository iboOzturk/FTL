...
class _MyPointPageState extends State<MyPointPage> {
  ...
  Future<void> loginnes() async{
    await getPointTeams(global.userid,haftaid);
  }
  ...
  void initState() {
    ...
    puanGetir();
    _refreshData2();
     getOldPoint(global.userid,haftaid);

     //getCaptains(global.userid);
    getCaptains2(global.userid,haftaid);
    super.initState();
  }
  Future<Null> _refreshData() async {
    await Future.delayed(Duration(seconds: 3));
   // getTakimim(global.userid);
    getPointTeams(global.userid,haftaid);
    // getCaptains(global.userid);
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: FutureBuilder(
        ...
        future: getOldPoint(global.userid,haftaid),
                  ...
                  child: Container(
                    ...
                    child: Column(mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        ...
                        SizedBox(height: 25,),
                        Text('Puanlarınız yükleniyor...',style: TextStyle(fontSize: 25,color: Colors.white),)
        ...
        return FutureBuilder(
            future: getPointTeams(global.userid,haftaid),
            builder: (BuildContext context,AsyncSnapshot snapshot){
                      ...
                      child: Container(
                        ...
                        child: Column(mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            ...
                            CircularProgressIndicator(color: Colors.white,),
                            SizedBox(height: 25,),
                            Text('Takımınız yükleniyor...',style: TextStyle(fontSize: 25,color: Colors.white),)
                  ...
                  child: new Scaffold(
                    ...
                    //  backgroundColor: Color.fromARGB(255, 55, 0, 60 ),
                              ...
                              children: [
                                ...
                                Row(mainAxisAlignment: MainAxisAlignment.center,
                                  children: [
                                    ...
                                    IconButton(icon: Icon(Icons.arrow_forward_ios),onPressed: () {
                                      setState(() {
                                         haftaid==(global.CurrentWeek+1)?haftaid=global.CurrentWeek+1: haftaid=haftaid+1;
                                       // global.captain==null||global.captain=='null'||global.captain==[]? haftaid=haftaid+1:haftaid=global.CurrentWeek+1;
                                      });
                                      _refreshData2();
                                    },),
                                ...
                                IconButton(onPressed: () {
                                  showDialog(context: context, builder: (BuildContext context){
                                    return AlertDialog(content: Text('Eğer ilk 11 futbolcunuzdan biri ya da daha fazlası maçta dakika almaz ise yedekler en soldan başlayarak ilk 11’e girer. Kaleci sadece yedek kaleci ile değişir.'),);
                                  });
                      ...
                      Container(alignment: Alignment.center,decoration: BoxDecoration(
                        ...
                        child: Text('$haftaid . HAFTAYA AİT TAKIMINIZ YOK',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 29),textAlign: TextAlign.center,),
                      ),):
                      Container(
                        width:MediaQuery.of(context).size.width ,height: MediaQuery.of(context).size.height,
                        decoration: BoxDecoration(
                                      ...
                                      children: [
                                        ...
                                        Expanded(flex:1,
                                          child: Container(alignment: Alignment.center,
                                             ...
                                             // child: Text(global.avgpoint==null?'0':global.avgpoint,
                                      ...
                                      children: [
                                        ...
                                        Expanded(flex:1,
                                          child: Container(alignment: Alignment.center,
                                            ...
                                            //  child: Text(global.maxpoint==null?'0':global.maxpoint,
