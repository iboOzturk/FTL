...
import 'package:fantasysuperlig/Screens/Leagues/yillikligpage.dart';
...
class TargetYillikPointPage extends StatefulWidget {
  @override
  _TargetYillikPointPageState createState() => _TargetYillikPointPageState();
}
...
class _TargetYillikPointPageState extends State<TargetYillikPointPage> {
                      ...
                      //  backgroundColor: Color.fromARGB(255, 55, 0, 60 ),
                        appBar: new AppBar(actions: [IconButton(icon: Icon(Icons.refresh),onPressed: _refreshData2,)],
                          ...
                          leading: new IconButton(
                            ...
                            onPressed: () { Navigator.push(context, MaterialPageRoute(builder: (context)=>YillikLeaguePage()));},),
                        ),
