...
class TargetPointPage extends StatefulWidget {
  @override
  _TargetPointPageState createState() => _TargetPointPageState();
}
                      ...
                      //  backgroundColor: Color.fromARGB(255, 55, 0, 60 ),
                        appBar: new AppBar(actions: [IconButton(icon: Icon(Icons.refresh),onPressed: _refreshData2,)],
                            ...
                            child: Container(alignment: Alignment.center,
                              ...
                              child: Row(mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  ...
                                  SizedBox(width: 10,),
                                  Visibility(
                                    visible: haftaid==global.CurrentWeek?false:true,
                                    child: IconButton(icon: Icon(Icons.arrow_forward_ios),onPressed: () {
                                      setState(() {
                                        haftaid==global.CurrentWeek?haftaid=global.CurrentWeek:haftaid=haftaid+1;
                                      });
                                      _refreshData2();
                                    },),
                                  ),
                          ...
                          leading: new IconButton(
                            ...
                            onPressed: () { Navigator.push(context, MaterialPageRoute(builder: (context)=>LeaguePage()));},),
                        ),
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            MyPuanWidget(
                                              ...
                                              emp: global.forvet0emp,
                                              puan:global.forvet0Puan==null?0:  global.forvet0Puan,
