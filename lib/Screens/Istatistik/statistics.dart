  ...
  /*  var data=[];
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(title: Text('Oyuncu İstatistikleri'),backgroundColor: Color(0xFF3366FF),
                                    ...
                                    Padding(
                                      ...
                                      child: Column(mainAxisAlignment: MainAxisAlignment.start,
                                        children: [
                                          ...
                                          Text(takimadi=='all'?'Tüm Takımlar':takimadi,style: TextStyle(color: Colors.black,),),
                                          SizedBox(width: 5,)
                                        ],
                                      ),
                                    ),
